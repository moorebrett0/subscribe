...
namespace subscribe\subscibe\fields;

use subscribe\subscibe\Subscibe;
use subscribe\subscibe\assetbundles\subscibefieldfield\SubscibeFieldFieldAsset;
 ...
 * @since     1.0.0
 */
class SubscibeField extends Field
{
    // Public Properties
    // =========================================================================
    ...
    {
        return Craft::t('subscibe', 'SubscibeField');
    }
    ...
    public function getSettingsHtml()
    {
        ...
        return Craft::$app->getView()->renderTemplate(
            'subscibe/_components/fields/SubscibeField_settings',
            [
                'field' => $this,
            ]
        );
    ...
    public function getInputHtml($value, ElementInterface $element = null): string
    {
        ...
        Craft::$app->getView()->registerAssetBundle(SubscibeFieldFieldAsset::class);
        ...
        Craft::$app->getView()->registerJs("$('#{$namespacedId}-field').SubscibeSubscibeField(" . $jsonVars . ");");

        // Render the input template
        return Craft::$app->getView()->renderTemplate(
            'subscibe/_components/fields/SubscibeField_input',
            [
                'name' => $this->handle,
                'value' => $value,
                'field' => $this,
